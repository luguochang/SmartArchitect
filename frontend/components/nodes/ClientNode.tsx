...
export const ClientNode = memo(({ id, data }: NodeProps) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: "var(--client-background)",
        boxShadow: "var(--client-shadow, 0 10px 15px -3px rgba(0,0,0,0.1))",
      }}
    >
      ...
      <Handle
        ...
        style={{
          backgroundColor: "var(--client-border)",
          top: 0,
          left: "50%",
      ...
      <span
        ...
        style={{ backgroundColor: "var(--client-border)" }}
      />

      <div className="flex items-center gap-3">
        <Monitor className="h-5 w-5 transition-transform duration-200 hover:scale-110" style={{ color: "var(--client-icon)" }} />
